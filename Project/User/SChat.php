...
$sel = "select * from tbl_traineer where traineer_id='".$_GET["id"]."'";
               $res = $con->query($sel);
                $row=$res->fetch_assoc();
?>
    <!DOCTYPE html>
    ...
    <body>
                    ...
                    <div class="nav-start">
                        <div class="recipient-block">
                            <div class="avatar-container">
                                <img class="user-avatar" src="../Assets/Files/Traineerdocs/<?php echo $row["traineer_photo"] ?>" alt="">
                            </div>
                            <div class="username">
                                <span><?php echo $row["traineer_name"] ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="nav-end">
        ...
        <script>
                                    ...
                                    function sendChat(id)
                                    {
                                        ...
                                        if (chat.length <= 35)
                                        {
                                            $.ajax({url: "../Assets/AjaxPages/SAjaxChat.php?chat=" + chat+"&id="+id,
                                    ...
                                    $(document).ready(function() {
                                        setInterval(function() {
                                            $("#conversation").load('SLoad.php?id=<?php echo $_GET["id"] ?>')
                                        }, 50);
                                    });
