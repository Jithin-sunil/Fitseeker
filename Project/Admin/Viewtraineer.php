...
if(isset($_GET["acpID"]))
	{
		$traineerid=$_GET["acpID"];
		$acpqry="update tbl_traineer set traineer_status='1' where traineer_id=$traineerid";
	if($con-> query($acpqry))
	{
        ...
        <?php
		// header("location:Viewtraineer.php");
	}
}
	if(isset($_GET["rejID"]))
	{
...
<title>FitSeeker::View Trainner</title>
</head>
...
<body>
 ...
 <tr>
		...
		<td width="168">Action</td>
        

</tr>
<tr>
		<?php
		$selqurey="select * from tbl_traineer u inner join tbl_place p on u.place_id = p.place_id  inner join tbl_district d on p.district_id=d.district_id inner join tbl_coursetype z on u.course_id=z.coursetype_id where traineer_status='0' ";
        ...
        while($data=$result->fetch_assoc())
		{
            ...
            <td><?php echo $data["place_name"]?></td>
             ...
             <td><img src="../Assets/Files/Traineerdocs/Image/<?php echo $data["traineer_photo"] ?>" width="50" height="50" /> </td>
              <td><img src="../Assets/Files/Traineerdocs/Proof/<?php echo $data["traineer_proof"] ?>" width="50" height="50" /> </td>
              ...
              <td><?php echo $data["traineer_experience"]?></td>
               ...
               <td><a href="Viewtraineer.php?acpID=<?php echo $data["traineer_id"]?>">ACCPET</a> &nbsp; &nbsp; <a href="Viewtraineer.php?rejID=<?php echo $data["traineer_id"]?>">REJECT</a></td>
