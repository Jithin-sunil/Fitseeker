...
if(isset($_GET["acpID"]))
	...
	if($con-> query($acpqry))
	{
        ...
        <script>
            alert("Accepted");
            window.location="Rejecttraineers.php";
        </script>
        <?php
	}
}
...
<title>FitSeeker::Rejecttraineers</title>
</head>
...
<tr>
		<?php
		$selqurey="select * from tbl_traineer u inner join tbl_place p on u.place_id = p.place_id  inner join tbl_district d on p.district_id=d.district_id inner join tbl_coursetype z on u.course_id=z.coursetype_id where traineer_status='2'";
        ...
        while($data=$result->fetch_assoc())
		{
            ...
            <td><?php echo $data["place_name"]?></td>
             ...
             <td><img src="../Assets/Files/Traineerdocs/<?php echo $data["traineer_photo"] ?>" width="50" height="50" /> 
             </td>
              ...
              <td><?php echo $data["traineer_experience"]?></td>
                       ...
                       <td><a href="Rejecttraineers.php?acpID=<?php echo $data["traineer_id"]?>">ACCPET</a></td>
