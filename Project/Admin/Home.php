                    ...
                    <table>
                        ...
                        while ($data = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td><img src="../Assets/Files/Sellerdocs/<?php echo $data["seller_image"] ?>" alt="Seller Image" />
                                </td>
                                <td><img src="../Assets/Files/Sellerdocs/<?php echo $data["seller_proof"] ?>" alt="Seller Proof" />
                                </td>
                        ...
                        <table>
                            ...
                            while ($data = $result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $data["district_name"] ?></td>
                                    <td><?php echo $data["place_name"] ?></td>
                                    <td><img src="../Assets/Files/Userdocs/<?php echo $data["user_photo"] ?>" alt="User Photo" />
                                    </td>
                                    <td><img src="../Assets/Files/Userdocs/<?php echo $data["user_proof"] ?>" alt="User Proof" />
                                    </td>
                                    <td>
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-secondary rounded p-4">
                            ...
                            <div class="d-flex align-items-center border-bottom py-3">
                                <img class="rounded-circle flex-shrink-0" src="../Assets/Templates/Admin/img/user.jpg" alt="" style="width: 40px; height: 40px;">
...
<!-- 
    ...
    <script src="../Assets/Templates/Adminlib/chart/chart.min.js"></script>
