            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li class="scroll-to-section"><a href="Guest/Traineerregisration.php">Register Traineer</a></li>
                      <li class="scroll-to-section"><a href="Guest/Sellerregisration.php">Register Seller</a></li>
                      <li class="scroll-to-section"><a href="Guest/Newuser.php">Register User</a></li>
