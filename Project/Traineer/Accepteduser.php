...
if(isset($_GET["rejID"]))
	...
	if($con-> query($rejqry))
	{
        ...
        <script>
            alert("Rejected");
            window.location="Accepteduser.php";
        </script>
        <?php
		// echo "Rejected";
		// header("location:Accepteduser.php");
	}
}
...
<title>FitSeeker::Accepted Users</title>
<style>
body {
...
<div class="table-container">
    <table>
        ...
        $selqurey="SELECT * FROM tbl_request r 
                   ...
                   WHERE request_status='1' and traineer_id='".$_SESSION["tid"]."'";
        ...
        <tr>
            ...
            <td><a href="Accepteduser.php?rejID=<?php echo $data["request_id"] ?>">Reject</a></td>
        </tr>
        <?php
        } 
        ?>
