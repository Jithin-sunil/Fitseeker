...
<tr>
  ...
  <tr>
    <td colspan="2"><a href="Traineerprofile.php">Traineerprofile</a></td>
  </tr>
  <tr>
    <td colspan="2"><a href="Course.php">Course</a></td>
  </tr>
  <tr>
    <td colspan="2"><a href="Achivements.php">Achivements</a></td>
  </tr>
  
  <tr>
    <td colspan="2"><a href="Gallery.php">Gallery</a></td>
  </tr><tr>
  ...
  <tr>
    <td colspan="2"><a href="Requesteduser.php">Requested Users</a></td>
  </tr>
   <tr>
    <td colspan="2"><a href="Accepteduser.php">Accepted Users</a></td>
  </tr>
     <tr>
    <td colspan="2"><a href="Rejecteduser.php">Rejected Users</a></td>
  </tr>
...
<body>
      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            ...
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              <li class="scroll-to-section"><a href="HOMEPAGE.php">
              ...
              <li class="scroll-to-section"><a href="Course.php">Courses</a></li>
              <li class="scroll-to-section"><a href="Gallery.php">Gallery</a></li>
              <li class="scroll-to-section"><a href="Achivements.php">Achivements</a></li>
              <li class="scroll-to-section"><a href="Requesteduser.php">Requests</a></li>
              <li class="scroll-to-section"><a href="Uploadintro.php">Upload Video</a></li>
              <li class="scroll-to-section"><a href="MyChat.php"><i class="fa-brands fa-facebook-messenger"></i></a></li>

              <li class="scroll-to-section"><a href="Traineerprofile.php">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <div class="icon">
              <img src="../Assets/Templates/Traineer/assets/images/service-01.png" alt="online degrees">
            </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <div class="icon">
              <img src="../Assets/Templates/Traineer/assets/images/service-02.png" alt="short courses">
            </div>
            <div class="main-content">
              <h4>Short Courses</h4>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <div class="icon">
              <img src="../Assets/Templates/Traineer/assets/images/service-03.png" alt="web experts">
            </div>
            <div class="main-content">
              <h4>Web Experts</h4>
      ...
      <div class="row event_box">
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="../Assets/Templates/Traineer/assets/images/course-01.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6  development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="../Assets/Templates/Traineer/assets/images/course-02.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design wordpress">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="../Assets/Templates/Traineer/assets/images/course-03.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="../Assets/Templates/Traineer/assets/images/course-04.jpg" alt=""></a>
              <span class="category">Development</span>
              <span class="price">
                <h6><em>$</em>450</h6>
              </span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="../Assets/Templates/Traineer/assets/images/course-05.jpg" alt=""></a>
              <span class="category">Wordpress</span>
              <span class="price">
                <h6><em>$</em>320</h6>
              </span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="../Assets/Templates/Traineer/assets/images/course-06.jpg" alt=""></a>
              <span class="category">Webdesign</span>
              <span class="price">
                <h6><em>$</em>240</h6>
              </span>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="../Assets/Templates/Traineer/assets/images/member-01.jpg" alt="">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="../Assets/Templates/Traineer/assets/images/member-02.jpg" alt="">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="../Assets/Templates/Traineer/assets/images/member-03.jpg" alt="">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="../Assets/Templates/Traineer/assets/images/member-04.jpg" alt="">
        ...
        <div class="col-lg-7">
          <div class="owl-carousel owl-testimonials">
            <div class="item">
              ...
              <div class="author">
                <img src="../Assets/Templates/Traineer/assets/images/testimonial-author.jpg" alt="">
                <span class="category">Full Stack Master</span>
                <h4>Claude David</h4>
              </div>
            </div>
        ...
        <div class="col-lg-12 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-3">
                <div class="image">
                  <img src="../Assets/Templates/Traineer/assets/images/event-01.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-9">
                <ul>
        ...
        <div class="col-lg-12 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-3">
                <div class="image">
                  <img src="../Assets/Templates/Traineer/assets/images/event-02.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-9">
                <ul>
        ...
        <div class="col-lg-12 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-3">
                <div class="image">
                  <img src="../Assets/Templates/Traineer/assets/images/event-03.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-9">
                <ul>
  ...
  <div class="contact-us section" id="contact">
    <div class="container">
      <div class="row">
        ...
        <div>
          <h6>Quick Links</h6>
          <li class="scroll-to-section"><a href="Accepteduser.php">Accepted User</a></li>
          <li class="scroll-to-section"><a href="Rejecteduser.php">Rejected User</a></li>
        </div>
        <div class="col-lg-6">
  ...
  <script src="../Assets/Templates/Traineer/vendor/jquery/jquery.min.js"></script>
  <script src="../Assets/Templates/Traineer/vendor/bootstrap/js/bootstrap.min.js"></script>
  <script src="../Assets/Templates/Traineer/assets/js/isotope.min.js"></script>
  <script src="../Assets/Templates/Traineer/assets/js/owl-carousel.js"></script>
  <script src="../Assets/Templates/Traineer/assets/js/counter.js"></script>
  <script src="../Assets/Templates/Traineer/assets/js/custom.js"></script>
