...
if(isset($_GET["acpID"]))
	...
	if($con-> query($acpqry))
	{
        ...
        <script>
            alert("Accepted");
            window.location="Requesteduser.php";
        </script>
        <?php
		// echo "Accepted";
		// header("location:Requesteduser.php");
	}
}
if(isset($_GET["rejID"]))
	{
		$requestid=$_GET["rejID"];
		$rejqry="update tbl_request set request_status='2' where request_id=$requestid";
	if($con-> query($rejqry))
	{
		?>
        <script>
...
<title>FitSeeker::Requested Users</title>
<style>
body {
...
<div class="table-container">
    <table>
        ...
        $selqurey="SELECT * FROM tbl_request r 
                   ...
                   WHERE request_status='0' and traineer_id='".$_SESSION["tid"]."'";
        ...
        <tr>
            ...
            <td><a href="Requesteduser.php?rejID=<?php echo $data["request_id"] ?>">Reject</a></td>
            <td><a href="Requesteduser.php?acpID=<?php echo $data["request_id"] ?>">Accept</a></td>
        </tr>
        <?php
        } 
        ?>
...
<div class="navigation-buttons">
    ...
    <a href="Rejecteduser.php"><button>View Rejected Users</button></a>
</div>
