...
<table width="200" border="1">
 <tr>
  ...
  <tr>
    <td colspan="2"><a href="Sellerprofile.php">Seller Profile</a></td>
  </tr>
   <tr>
  ...
  <tr>
    ...
    <tr>
    <td colspan="2"><a href="viewbookings.php">viewbookings</a></td>
  </tr>
    <tr>
    <td colspan="2"><a href="Product.php">Product</a></td>
  </tr>
...
<body>
        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                      <li class="scroll-to-section"><a href="HomePAGE.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
  <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z"/>
                      ...
                      <li class="scroll-to-section"><a href="viewbookings.php">Bookings</a></li>
                      
                      <li class="scroll-to-section"><a href="viewcompliant.php">Complaints</a></li>
                      <li class="scroll-to-section"><a href="Viewreturnedproduct.php">Returned Products</a></li>
                      <li class="scroll-to-section"><a href="Sellerprofile.php">
